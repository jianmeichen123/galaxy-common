...
public class OSSDownloadFile  implements Callable<Integer>{
    ...
    public Integer call(){
       ...
       //           downloadPartObj.getDownloadPartThreads().add(new DownloadPartThread(startPos, endPos, localFilePath, bucketName, key,OSSConstant.ACCESS_ID,OSSConstant.ACCESS_KEY));
                }
        }
