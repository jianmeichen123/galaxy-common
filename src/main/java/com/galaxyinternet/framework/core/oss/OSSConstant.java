...
public class OSSConstant {
	public final static long DOWNLOAD_PART_SIZE = 5 * 1024 * 1024L; // 每个下载Part的大小设置为4MB

	public final static long UPLOAD_PART_SIZE = 5 * 1024 * 1024L; // 每个上传Part的大小设置为4MB
	...
	public static int SERIALIZATION_TIME = 0;// 断点保存时间间隔(秒)
